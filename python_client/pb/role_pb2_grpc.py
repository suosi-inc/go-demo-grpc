...
class RoleServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Get = channel.unary_unary(
                '/protobuf.RoleService/Get',
                request_serializer=role__pb2.GetRoleRequest.SerializeToString,
                response_deserializer=role__pb2.GetRoleResponse.FromString,
                )
...
def add_RoleServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Get': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=role__pb2.GetRoleResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'protobuf.RoleService', rpc_method_handlers)
...
class RoleService(object):
    ...
    def Get(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/protobuf.RoleService/Get',
            role__pb2.GetRoleRequest.SerializeToString,
            role__pb2.GetRoleResponse.FromString,
